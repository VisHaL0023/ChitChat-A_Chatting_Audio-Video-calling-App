...
public class setUpProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.profilePicIV.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        binding.setupProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedImage != null) {
                    ...
                    Users user = new Users(uid, name, phone, "No Image Found");
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (data != null) {
            if (data.getData() != null) {
                binding.profilePicIV.setImageURI(data.getData());
